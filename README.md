...
**Platforms** -
Microsoft Azure · Google Cloud Services · GitHub · Octopus Deploy

**Programming Languages and Frameworks** -
C# · JavaScript · TypeScript · PowerShell · SQL · VB.NET
.NET Framework · .NET Standard · .NET Core · ASP.NET · ASP.NET MVC · ASP.NET AJAX · React

**Software Development Tools** -
Visual Studio · VS Code · xUnit · NUnit · Postman · Insomnia · NDepend · Git · SourceGear Vault · Telerik · IIS

**Database Management Systems** -
Microsoft SQL Server · PostgreSQL · Oracle · MySQL · MongoDB · Microsoft Access

**Practices** -
Agile software development · Test-driven development · Application architecture · Database design · Requirements analysis · Software project management · SDLC · Business intelligence · SSIS · Web services · Integration · Static code analysis · CQRS and event sourcing · ETL · Multi-tenant data partitioning

**Security & Infrastructure** -
IIS hosting and log analysis · IPBan brute-force protection · TLS / SSL · Multi-factor authentication · Role-based access control
...
**Bachelor of Science (B.Sc.), Computer Science** - University of Northern British Columbia (May 1998)
Coursework included software engineering, compiler design, management information systems, database systems, operating systems, computer architecture, distributed systems. Cumulative GPA: 4.0.
...
Content (prose, biography, engagement summaries, and other written material) is © 2026 Daniel Miller. All rights reserved.
